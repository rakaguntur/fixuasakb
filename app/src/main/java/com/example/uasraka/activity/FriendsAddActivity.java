...
public class FriendsAddActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void showAlertDialog(int type){
        ...
        if (isDialogClose){
            dialogTitle = "Batal";
            dialogMessage = "Yakin untuk membatalkan?";
        } else{
            dialogMessage = "Yakin untuk menghapus?";
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        if (isDialogClose){
                            ...
                            if (result > 0){
                                ...
                                Toast.makeText(FriendsAddActivity.this, "Gagal menghapus", Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
                })
